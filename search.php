...
$s=$_POST["s"];
   ...
   $sql="SELECT * FROM post WHERE title = '$s' OR author = '$s' OR genre = '$s' OR quality = '$s' OR cat = '$s' ";
...
echo "Nothing found ...Try different search terms";
}
   }
   else{
echo "Nothing found ...Try different search terms";
	   ...
	   header("location: index.php");
				...
				<div class = "col-sm-3 well" id = "about">
					Medullo is a tool that helps you <span id = "searchLink"> <a href = "http://localhost/medulo/home.php">find resources </a> </span>like books, videos, music, games and all things fun among peers for sharing! 
					What's more? You too can <span id = "shareLink"> <a href = "http://localhost/medulo/home.php?#share"> share your favourite things</a> </span> with the world. Now! 
				</div>
			</div>
		</div>
	</body>
